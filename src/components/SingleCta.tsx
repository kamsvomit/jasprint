...
export default function SingleCta() {
  return (
    <section className="px-4 sm:px-5">
      <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-red-600 via-red-500 to-orange-400 p-7 text-white">
        {/* Deco */}
        ...
        <div className="relative space-y-5">
          ...
          <div className="grid grid-cols-3 gap-2">
            {stats.map((s, i) => (
              <div key={i} className="bg-white/15 rounded-2xl py-2.5 px-1 text-center">
