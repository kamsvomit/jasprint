...
export default function AdminShell({ children, title, subtitle }: AdminShellProps) {
  ...
  return (
    <div className="min-h-screen bg-[#0f1011] flex">
      ...
      {/* Sidebar */}
      <aside className={`
        fixed top-0 left-0 h-full w-60 bg-[#161718] border-r border-white/[0.06] z-30
      ...
      `}>
        ...
        <div className="p-5 border-b border-white/[0.06]">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <p className="text-white font-black text-sm leading-none">jasprint</p>
        ...
        <div className="p-3 border-t border-white/[0.06]">
          <div className="flex items-center gap-2.5 px-3 py-2.5 rounded-xl bg-white/[0.03]">
            ...
            <div className="flex-1 min-w-0">
              <p className="text-white/70 text-xs font-bold truncate">{user.email}</p>
          ...
          <a
            href="/"
            target="_blank"
            className="mt-2 flex items-center gap-2 px-3 py-2 rounded-xl text-white/30 hover:text-white/60 hover:bg-white/5 transition-all text-xs font-medium"
          >
      ...
      <div className="flex-1 flex flex-col min-w-0 lg:ml-0">
        {/* Top bar */}
        <header className="h-14 border-b border-white/[0.06] flex items-center px-4 lg:px-6 gap-3 flex-shrink-0">
          <button
          ...
          <div>
            <h1 className="text-white font-black text-base leading-tight">{title}</h1>
